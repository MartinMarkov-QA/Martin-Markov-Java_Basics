...
public class Bottles99 {
    public static void main(String[] args) {
        String bottles99SongText = "99 bottles of beer on the wall, 99 bottles of beer.\n" +
                "Take one down and pass it around, 98 bottles of beer on the wall.\n" +
                "\n" +
        ...
        int counter = 0;
        while (counter < bottles99SongText.length()) {
            System.out.print(bottles99SongText.charAt(counter));
            counter++;
        }
    }
}
